...
class Cliente extends \Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nome', 'status', 'documento', 'telefone', 'celular', 'email', 'senha', 'cep', 'endereco', 'bairro', 'cidade', 'estado', 'numero', 'complemento', 'criadoEm', 'ordensDeServicos', 'avaliacoes'];
        }

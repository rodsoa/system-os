...
class OrdemDeServico extends \Entity\OrdemDeServico implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cliente', 'tecnico', 'produtos', 'avaliacao', 'descricao', 'defeito', 'observacoes', 'laudoTecnico', 'garantia', 'situacao', 'status', 'valorTotal', 'dataInicial', 'dataFinal', 'criadoEm', 'atualizadoEm'];
        }
